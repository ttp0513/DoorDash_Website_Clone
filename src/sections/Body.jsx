  ...
  return (
    <section id="body">
      <div className="relative">
        {/* First Promo */}
        <div className="w-full flex flex-col md:flex-row lg:gap-10 items-center bg-body-background lg:bg-transparent lg:relative z-10">
          ...
          <div className="w-full lg:w-[40%] flex order-2 md:order-1 px-10 lg:px-20 lg:ml-20">
            <Card
        ...
        {/* Second Promo */}
        <div className="relative w-full flex flex-col md:flex-row items-center py-22 bg-body-background z-0 lg:px-20">
        ...
        <div className="bg-[url(https://img.cdn4dd.com/cdn-cgi/image/fit=cover,format=auto,quality=60/https://cdn.doordash.com/managed/consumer/seo/home/landing_cta/convenience_desktop.png)]">
            <div className="relative container mx-auto lg:px-50">
            <Card
        ...
        {/* 4th Promo */}
        <div className="w-full flex flex-col md:flex-row lg:gap-10 py-10 items-center bg-body-background lg:bg-transparent lg:relative z-10">
          <div className="order-1 md:order-2 ">
            <img
      ...
      <div className="bg-body-background">
        <div className="container mx-auto relative overflow-hidden ">
          <div className="container mx-auto w-90">
            <h1 className="py-16 text-2xl md:text-3xl font-bold text-headline text-center">
